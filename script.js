...
function clearCompleted() {
  clearCompletedButton.addEventListener('click', () => {
    while (completedList.length > 0) {
      ...
      completedList[0].parentNode.removeChild(completedList[0]); //excluo o filho acessando o pai, como cada elemento( com classe completed) tem um pai diferente (li's diferentes) preciso criar um clico com while para acessar cada pai separado e assim excluir seu unico filho.
      // ....
    };
  });
}
...
function clearselected() {
  clearSelectedButton.addEventListener('click', () => {
    while (selectedList.length > 0) {
      //  acessado https://qastack.com.br/programming/4777077/removing-elements-by-class-name
      selectedList[0].parentNode.removeChild(selectedList[0]); //excluo o filho acessando o pai, como cada elemento( com classe completed) tem um pai diferente (li's diferentes) preciso criar um clico com while para acessar cada pai separado e assim excluir seu unico filho.
      // ....
    }
  })
}
